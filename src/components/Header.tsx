    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-slate-200 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          {/* Logo — oversized, overlaps below the navbar */}
          <a href="#hero" className="relative flex items-center gap-3 group">
            <div className="relative -my-6 md:-my-8 z-10 drop-shadow-lg transition-transform duration-300 group-hover:scale-105">
              <Logo size="lg" />
            </div>
            <div className="leading-tight">
              <span className="block text-lg md:text-xl font-bold text-ocean-900 tracking-tight">
                Jersey Shore
              </span>
              <span className="block text-[10px] md:text-xs text-slate-500 uppercase tracking-[0.2em]">
                Window Tinting
              </span>
            </div>
          </a>
